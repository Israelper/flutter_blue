...
public class FlutterBluePlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, RequestPermissionsResultListener {
    ...
    private EventChannel newStateStatusChannelEvent;
    EventSink eventSinkStatusScreen;
    ...
    public void onStatusUpdate(ScreenStatus screenStatus) {
        onStatusUpdate(screenStatus, null);

    }

    public void onStatusUpdate(final ScreenStatus screenStatus, final String info) {
        Log.v("DANIEL-APP", screenStatus.name() + ((info == null) ? "  " : " , " + info));
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (eventSinkStatusScreen != null) {
                    HashMap<String, String> hashMap = new HashMap<>();
                    hashMap.put("screenStatus", screenStatus.name());
                    hashMap.put("desc", info);
                    eventSinkStatusScreen.success(hashMap);
                }
            }
        });
    ...
    private void setup(
        ...
        synchronized (initializationLock) {
            ...
            newStateStatusChannelEvent = new EventChannel(messenger, "SCREEN_STATUS");
            newStateStatusChannelEvent.setStreamHandler(new StreamHandler() {
                @Override
                public void onListen(Object arguments, EventSink events) {
                    eventSinkStatusScreen = events;
                }

                @Override
                public void onCancel(Object arguments) {
                    eventSinkStatusScreen = null;
                }
            });
    ...
    private void tearDown() {
        ...
        stateChannel = null;
        newStateStatusChannelEvent.setStreamHandler(null);
        newStateStatusChannelEvent = null;
        ...
        switch (call.method) {
            ...
            case "deviceState": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "device_state_error: " + e.getMessage());
            ...
            case "readCharacteristic": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "read_characteristic_error ");
                ...
                if (gattServer.readCharacteristic(characteristic)) {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "read_characteristic_error 2");
            ...
            case "readDescriptor": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "read_descriptor_error 1");
                ...
                if (gattServer.readDescriptor(descriptor)) {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "read_descriptor_error 2");
            ...
            case "writeCharacteristic": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "the writeCharacteristic  " + e.getMessage());
                    result.error("RuntimeException", e.getMessage(), e);
                    break;
                }
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "write_characteristic_error ");
                ...
                if (!characteristic.setValue(request.getValue().toByteArray())) {
                    onStatusUpdate(ScreenStatus.ERROR, "write_characteristic_error 2 ");
                ...
                if (!gattServer.writeCharacteristic(characteristic)) {
                    onStatusUpdate(ScreenStatus.ERROR, "fail write data");
            ...
            case "writeDescriptor": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "write_descriptor_error");
            ...
            case "setNotification": {
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "setNotification: " + e.getMessage());
                    result.error("RuntimeException", e.getMessage(), e);
                    break;
                }
                ...
                try {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "set_notification_error " + e.getMessage());
                ...
                if (request.getEnable()) {
                    ...
                    if (!canIndicate && !canNotify) {
                        onStatusUpdate(ScreenStatus.ERROR, "set_notification_error 1");
                ...
                if (!gattServer.setCharacteristicNotification(characteristic, request.getEnable())) {
                    onStatusUpdate(ScreenStatus.ERROR, "set_notification_error 2");
                ...
                if (!cccDescriptor.setValue(value)) {
                    onStatusUpdate(ScreenStatus.ERROR, "set_notification_error 3");
                ...
                if (!gattServer.writeDescriptor(cccDescriptor)) {
                    onStatusUpdate(ScreenStatus.ERROR, "set_notification_error 4");
    ...
    private void stopScan() {
        onStatusUpdate(ScreenStatus.STOP_SCANNING);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            stopScan21();
        } else {
            stopScan18();
        ...
        if (scanCallback21 == null) {
            scanCallback21 = new ScanCallback() {
                ...
                public void onScanFailed(int errorCode) {
                    ...
                    onStatusUpdate(ScreenStatus.ERROR, "Scan fail code: " + errorCode);
                }
            };
        }
    ...
    private long lastWriteData = 0;
    final int DURATION_DELAY = 1000;
    private final Handler handlerDataUploaded = new Handler();
    private final Runnable runnableDataUploaded = new Runnable() {
        @Override
        public void run() {
            long duration = System.currentTimeMillis() - lastWriteData;
            Log.v("DANIEL-APP", "Duration: " + duration);
            if (duration >= DURATION_DELAY)
                onStatusUpdate(ScreenStatus.READY);
        }
    };
    ...
    private void startScan21(Protos.ScanSettings proto) throws IllegalStateException {
        ...
        onStatusUpdate(ScreenStatus.SCANNING);
    }
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                onStatusUpdate(ScreenStatus.DISCONNECTED);
                ...
                onStatusUpdate(ScreenStatus.CONNECTED);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic
            ...
            if (status != BluetoothGatt.GATT_SUCCESS)
                onStatusUpdate(ScreenStatus.ERROR, "onCharacteristicWrite error");
            else
                onStatusUpdate(ScreenStatus.UPLOAD_IMAGE);

            invokeMethodUIThread("WriteCharacteristicResponse", p.build().toByteArray());

            lastWriteData = System.currentTimeMillis();
            handlerDataUploaded.removeCallbacks(runnableDataUploaded);
            handlerDataUploaded.postDelayed(runnableDataUploaded, DURATION_DELAY);
        }
        ...
        public void onDescriptorRead(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
            ...
            onStatusUpdate(ScreenStatus.INITIALIZING);
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
            ...
            if (status != BluetoothGatt.GATT_SUCCESS)
                onStatusUpdate(ScreenStatus.ERROR, "onDescriptorWrite error");
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                onStatusUpdate(ScreenStatus.ERROR, "fail mtu size request");
            }
